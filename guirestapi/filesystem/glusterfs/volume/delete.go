...
// @Title delete
// @Description delete the gluster volume
// @Param glusterfsVolume path string true "The name of gluster volume"
// @Param clusterName path string true "The name of gluster cluster configuration"
// @Success 200 {string} {}
// @Failure 404 error reason
// @router /:clusterName/:glusterfsVolume [delete]
