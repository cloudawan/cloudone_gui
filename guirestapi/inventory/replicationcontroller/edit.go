...
// @Param body body guirestapi.inventory.replicationcontroller.ReplicationController true "body for replication controller"
// @Success 200 {string} {}
...
func (c *EditController) Post() {
	...
	err := json.Unmarshal(inputBody, &replicationController)
	if err != nil {
		// Error
